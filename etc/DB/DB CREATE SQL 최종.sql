...
-- account_transaction
INSERT INTO account_transaction VALUES (501, 301, 15000, 'AP001', '카페', TO_DATE('2024-02-01','YYYY-MM-DD'), '스타벅스', '010-1111-1111');
INSERT INTO account_transaction VALUES (502, 302, 50000, 'AP002', '마트', TO_DATE('2024-02-02','YYYY-MM-DD'), '이마트', '010-2222-2222');
INSERT INTO account_transaction VALUES (503, 303, 200000, 'AP003', '의료', TO_DATE('2024-02-03','YYYY-MM-DD'), '서울병원', '010-3333-3333');
INSERT INTO account_transaction VALUES (504, 304, 80000, 'AP004', '교육', TO_DATE('2024-02-04','YYYY-MM-DD'), 'YBM어학원', '010-4444-4444');
INSERT INTO account_transaction VALUES (505, 305, 12000, 'AP005', '영화', TO_DATE('2024-02-05','YYYY-MM-DD'), 'CGV', '010-5555-5555');
