...
DROP TABLE benefit_category CASCADE CONSTRAINTS;
...
CREATE TABLE card_product (
    ...
    imgdate VARCHAR2(255) NOT NULL,
    namev VARCHAR2(255) NOT NULL,
    brand VARCHAR2(255) NOT NULL,
    description VARCHAR2(255) NOT NULL,
    category VARCHAR2(255) NOT NULL,
    benefit_id NUMBER(8, 2) NOT NULL,
    interest NUMBER(8, 2) NOT NULL,
    limit NUMBER(8, 2) NOT NULL,
    type VARCHAR2(255) NOT NULL,
    CONSTRAINT pk_card_product PRIMARY KEY (card_id)
);
...
CREATE TABLE benefit_category (
    benefit_cg_id NUMBER(8, 2) NOT NULL,
    benefit_id NUMBER(8, 2) NOT NULL,
    cat_food_ent NUMBER NOT NULL,
    cat_retail NUMBER NOT NULL,
    cat_sports_culture_lzr NUMBER NOT NULL,
    cat_home_service NUMBER NOT NULL,
    cat_edu_academy NUMBER NOT NULL,
    cat_medical NUMBER NOT NULL,
    cat_auto NUMBER NOT NULL,
    cat_ecommerce NUMBER NOT NULL,
    CONSTRAINT pk_benefit_category PRIMARY KEY (benefit_id)
);

ALTER TABLE card_product
    ADD CONSTRAINT fk_card_product_benefit_id FOREIGN KEY (benefit_id)
    REFERENCES benefit_category (benefit_id);
...
-- users
INSERT INTO users VALUES (1, TO_DATE('2024-01-01','YYYY-MM-DD'), '서울시 강남구', '101호', '06236', 'user1@example.com', '홍길동', 'hong1', 'pw1', '010-1111-2222', 'token1', '1111', 0, 'M', TO_DATE('1990-05-15','YYYY-MM-DD'));
INSERT INTO users VALUES (2, TO_DATE('2024-01-02','YYYY-MM-DD'), '서울시 마포구', '202호', '04123', 'user2@example.com', '김철수', 'kimcs', 'pw2', '010-2222-3333', 'token2', '2222', 0, 'M', TO_DATE('1988-08-22','YYYY-MM-DD'));
INSERT INTO users VALUES (3, TO_DATE('2024-01-03','YYYY-MM-DD'), '부산시 해운대구', '303호', '48095', 'user3@example.com', '이영희', 'leeyh', 'pw3', '010-3333-4444', 'token3', '3333', 0, 'F', TO_DATE('1992-03-10','YYYY-MM-DD'));
INSERT INTO users VALUES (4, TO_DATE('2024-01-04','YYYY-MM-DD'), '대구시 수성구', '404호', '42111', 'user4@example.com', '박민수', 'parkms', 'pw4', '010-4444-5555', 'token4', '4444', 0, 'M', TO_DATE('1995-12-01','YYYY-MM-DD'));
INSERT INTO users VALUES (5, TO_DATE('2024-01-05','YYYY-MM-DD'), '인천시 남동구', '505호', '21555', 'user5@example.com', '최지은', 'choije', 'pw5', '010-5555-6666', 'token5', '5555', 1, 'F', TO_DATE('1993-07-19','YYYY-MM-DD'));
